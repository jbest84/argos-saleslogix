...
import DefaultMetrics = require('./DefaultMetrics');
import ErrorManager = require('argos/ErrorManager');
import environment = require('./Environment');
import Application = require('argos/Application');
import sniff = require('dojo/sniff');
import moment = require('moment');

var __unused__ = sniff;
...
var __class = declare('crm.Application', [Application], {
    ...
    loadCustomizedMoment: function() {
        ...
        this.moment = (<any>moment()).lang(currentLang, custom);
    },
    /*
